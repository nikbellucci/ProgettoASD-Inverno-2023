...
public class Esercizio1 {
    ...
    private static HashMap<Long, String> ciuToPr = new HashMap<>();
    ...
    public static void parseLibraries(String inputfile) throws IOException {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(inputfile))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                String link = data[3];
                long code = Long.parseLong(data[4]);
...
//        System.out.println("Libreria non presente");
    ...
    private static Library searchByCode(long code) {
    ...
    private static void parseCiuToPr(String[] args) throws IOException{
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(args[0]))) {
            ...
            while ((line = reader.readLine()) != null) {
                String[] data = line.split(" ");
                long tmp = Long.parseLong(data[0]);
                long ciu = tmp;
                String pr = data[1];
                ciuToPr.put(ciu, pr);
            }
     ...
     * @return
     */
    private static boolean checkCIU(long code) {
...
class Library {
    ...
    public Library(String name, String city, String address,int year, String link, long code) {
        this.name = name;
        this.city = city;
